...
{
    public TargetReciept(string _LCstoreName, int _LCPuchaseDate, int _LCpoints, int _LCpurchaseTotal) : base(_LCstoreName, _LCPuchaseDate, _LCpoints, _LCpurchaseTotal)
    {
